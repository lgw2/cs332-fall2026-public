...
\item (1 point) Write the reucrrence describing the following algorithm's runtime.
...
\end{algo}
    ...
    \begin{equation*}
        ...
        \end{cases}
    \end{equation*}
\item (3 points) Using induction, prove that the sum of the degrees of all vertices in an
...
\item (6 points) Suppose you are given a stack of $n$ pancakes of different sizes. You want to
